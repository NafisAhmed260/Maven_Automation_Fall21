...
public class Reusable_Actions {
    ...
    public static void ScrollingPixel(WebDriver driver, String s, String s1) {
    }

    public static void sendMethod(WebDriver driver, String s, String s1, String email) {
    }

    public static void scrollByPixelMethod(WebDriver driver, String s, String s1, String scroll) {
    }
}//end of java
