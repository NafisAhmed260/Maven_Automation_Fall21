...
public class Reusable_Actions_Loggers {
    ...
    public static void clickByIndex(WebDriver driver, String s, int i, ExtentTest logger, String second_pic) {
    }

    public static void selectByVisibleText(WebDriver driver, String s, String state, ExtentTest logger, String state1) {
    }
}
